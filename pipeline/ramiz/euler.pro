...
;-
 ...
 if npar LT 2 then begin
    ...
    print,'    SELECT   From          To        |   SELECT      From            To'
    print,'    1     RA-Dec (2000)  Galactic   |     4       Ecliptic      RA-Dec'
    print,'    2     Galactic       RA-DEC     |     5       Ecliptic      Galactic'
    print,'    3     RA-Dec         Ecliptic   |     6       Galactic      Ecliptic'
